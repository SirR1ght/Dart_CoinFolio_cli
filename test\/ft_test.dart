...
void main() {
List<String> symbol = ["BNBBUSD"];
List<String> symbols = ["BTCBUSD", "ETHBUSD"];
print("1. No symbol String: ${urlGet([])}");
print("2. One symbols String: ${urlGet(symbol)}");
print("3. Many symbols String: ${urlGet(symbols)}");
}